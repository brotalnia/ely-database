...
-- Gornek should do talk emote when offering quests Etched Tablet, Etched Perchament.
-- Jen'Shan should do bow emote on completed quests Etched Tablet, Etched Perchament.
-- Jen'Shan should do talk emote when turning in quests Etched Tablet, Etched Perchament.
UPDATE `quest_template` SET `DetailsEmote1`=1, `CompleteEmote`=2, `OfferRewardEmote1`=1 WHERE `entry` IN (3082, 3087);
...
-- Zureetha Fargaze should do talk emote when offering quest Vile Familiars
-- Zureetha Fargaze should do talk emote when turning in quest Vile Familiars
UPDATE `quest_template` SET `DetailsEmote1`=1, `OfferRewardEmote1`=1 WHERE `entry`=792;
...
-- Zureetha Fargaze should do talk emote when offering quest Burning Blade Medallion
-- Zureetha Fargaze should do bow emote when turning in quest Burning Blade Medallion
UPDATE `quest_template` SET `DetailsEmote1`=1, `OfferRewardEmote1`=2 WHERE `entry`=794;

-- Foreman Thazz'ril should do shout emote when offering quest Lazy Peons
-- Foreman Thazz'ril should do shout emote on completed quest Lazy Peons
-- Foreman Thazz'ril should do talk emote when turning in quest Lazy Peons
UPDATE `quest_template` SET `DetailsEmote1`=5, `CompleteEmote`=5, `OfferRewardEmote1`=1 WHERE `entry`=5441;

-- Foreman Thazz'ril should do talk emote when offering quest Thazz'ril's Pick
UPDATE `quest_template` SET `DetailsEmote1`=1 WHERE `entry`=6394;
...
-- Master Gadrin should do talk emote when offering quest Report to Orgnil
-- Orgnil Soulscar should bow when turning in quest Report to Orgnil
UPDATE `quest_template` SET `DetailsEmote1`=1, `OfferRewardEmote1`=2 WHERE `entry`=823;

-- Master Vornal should do talk emote when offering quest A Solvent Spirit
-- Master Vornal should do bow emote when turning in quest A Solvent Spirit
UPDATE `quest_template` SET `DetailsEmote1`=1, `OfferRewardEmote1`=2 WHERE `entry`=818;

-- Vel'rin Fang should do talk emote when offering quest Practical Prey
-- Vel'rin Fang should do two talk emotes when turning in quest Practical Prey
UPDATE `quest_template` SET `DetailsEmote1`=1, `OfferRewardEmote1`=1, `OfferRewardEmote2`=1 WHERE `entry`=817;

-- Gar'Thok should do shout emote when offering quest Vanquish the Betrayers
-- Gar'Thok should do point emote on incomplete quest Vanquish the Betrayers
-- Gar'Thok should do salute emote when turning in quest Vanquish the Betrayers
UPDATE `quest_template` SET `DetailsEmote1`=5, `IncompleteEmote`=29, `OfferRewardEmote1`=66 WHERE `entry`=784;
...
-- Furl Scornbrow should do bow emote when offering quest Carry Your Weight
-- Furl Scornbrow should do cheer emote when turning in quest Carry Your Weight
UPDATE `quest_template` SET `DetailsEmote1`=2, `OfferRewardEmote1`=4 WHERE `entry`=791;

-- Innkeeper Grosk should do a shrug emote when turning in quest A Peon's Burden
UPDATE `quest_template` SET `OfferRewardEmote1`=6 WHERE `entry`=2161;
...
-- Gar'Thok should do shrug emote on completed quest The Admiral's Orders
-- Gar'Thok should do talk emote when turning in quest The Admiral's Orders
UPDATE `quest_template` SET `CompleteEmote`=6, `OfferRewardEmote1`=1 WHERE `entry`=830;
...
-- Master Gadrin should not do an emote on completed quest Minshina's Skull
...
-- Misha Tor'kren should do cry emote when offering quest Lost But Not Forgotten
UPDATE `quest_template` SET `DetailsEmote1`=18 WHERE `entry`=816;

-- Thotar should do talk emote when offering quest Taming the Beast
-- Thotar should not do an emote on completed quest Taming the Beast
-- Thotar should do yes emote when turning in quest Taming the Beast
UPDATE `quest_template` SET `DetailsEmote1`=1, `CompleteEmote`=0, `OfferRewardEmote1`=273 WHERE `entry`=6062;

-- Thotar should do talk emote when offering quest Taming the Beast 2
-- Thotar should not do an emote on completed quest Taming the Beast 2
-- Thotar should do yes emote when turning in quest Taming the Beast 2
UPDATE `quest_template` SET `DetailsEmote1`=1, `CompleteEmote`=0, `OfferRewardEmote1`=273 WHERE `entry`=6083;

-- Thotar should do talk emote when offering quest Taming the Beast 3
-- Thotar should not do an emote on completed quest Taming the Beast 3
-- Thotar should do yes emote when turning in quest Taming the Beast 3
UPDATE `quest_template` SET `DetailsEmote1`=1, `CompleteEmote`=0, `OfferRewardEmote1`=273 WHERE `entry`=6082;

-- Thotar should do talk emote when offering quest Training the Beast
-- Ormak Grimshot should do yes emote when turning in quest Training the Beast
UPDATE `quest_template` SET `DetailsEmote1`=1, `OfferRewardEmote1`=273 WHERE `entry`=6081;

-- Rhinag should do talk emote when offering quest Need for a Cure
UPDATE `quest_template` SET `DetailsEmote1`=1 WHERE `entry`=812;

-- Thrall should do talk emote when offering quest Hidden Enemies 1
UPDATE `quest_template` SET `DetailsEmote1`=1 WHERE `entry`=5726;

-- Kor'ghan should do talk emote when offering quest Finding the Antidote
UPDATE `quest_template` SET `DetailsEmote1`=1 WHERE `entry`=813;
