...
-- Diamond Flask should scale with spell power.
UPDATE `spell_template` SET `customFlags`=`customFlags`+2048 WHERE `entry`=24427;
INSERT INTO `spell_bonus_data` (`entry`, `direct_bonus`, `dot_bonus`, `ap_bonus`, `ap_dot_bonus`, `comments`, `build_min`, `build_max`) VALUES (24427, 1, 1, 0, 0, 'Diamond Flask - Scales at 100%', 0, 5875);
